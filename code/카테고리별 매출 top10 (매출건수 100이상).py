...
# 필요한 열만 선택 (구, 동, category20, 기준_년분기_코드, 당월_매출_금액, 점포_수, {요일}_매출_건수)
data = data[['자치구_코드_명', '행정동_코드_명', 'category20', '기준_년분기_코드', 
             '당월_매출_금액', '점포_수', '월요일_매출_건수', '화요일_매출_건수', 
...
# 매출 건수가 100 미만인 행정동 제거
days = ['월요일', '화요일', '수요일', '목요일', '금요일', '토요일', '일요일']
for day in days:
    count_column = f'{day}_매출_건수'
    sum_20233 = sum_20233[sum_20233[count_column] >= 100]
    sum_20234 = sum_20234[sum_20234[count_column] >= 100]
