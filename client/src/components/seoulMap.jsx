...
const Map = ({ selectedArea, handleAreaClick }) => (
  <svg
  ...
  `}
    ...
    <g filter="url(#dropshadow)">
      <Link to="/11110" onClick={() => handleAreaClick("CD11110")}>
        <path
          id="CD11110"
          className={`OUTLINE ${selectedArea === "CD11110" ? "selected" : ""}`}
      ...
      <Link to="/11140" onClick={() => handleAreaClick("CD11140")}>
        <path
          id="CD11140"
          className={`OUTLINE ${selectedArea === "CD11140" ? "selected" : ""}`}
      ...
      <Link to="/11170" onClick={() => handleAreaClick("CD11170")}>
        <path
          id="CD11170"
          className={`OUTLINE ${selectedArea === "CD11170" ? "selected" : ""}`}
      ...
      <Link to="/11200" onClick={() => handleAreaClick("CD11200")}>
        <path
          id="CD11200"
          className={`OUTLINE ${selectedArea === "CD11200" ? "selected" : ""}`}
      ...
      <Link to="/11215" onClick={() => handleAreaClick("CD11215")}>
        <path
          id="CD11215"
          className={`OUTLINE ${selectedArea === "CD11215" ? "selected" : ""}`}
      ...
      <Link to="/11230" onClick={() => handleAreaClick("CD11230")}>
        <path
          id="CD11230"
          className={`OUTLINE ${selectedArea === "CD11230" ? "selected" : ""}`}
      ...
      <Link to="/11260" onClick={() => handleAreaClick("CD11260")}>
        <path
          id="CD11260"
          className={`OUTLINE ${selectedArea === "CD11260" ? "selected" : ""}`}
      ...
      <Link to="/11290" onClick={() => handleAreaClick("CD11290")}>
        <path
          id="CD11290"
          className={`OUTLINE ${selectedArea === "CD11290" ? "selected" : ""}`}
      ...
      <Link to="/11305" onClick={() => handleAreaClick("CD11305")}>
        <path
          id="CD11305"
          className={`OUTLINE ${selectedArea === "CD11305" ? "selected" : ""}`}
      ...
      <Link to="/11320" onClick={() => handleAreaClick("CD11320")}>
        <path
          id="CD11320"
          className={`OUTLINE ${selectedArea === "CD11320" ? "selected" : ""}`}
      ...
      <Link to="/11350" onClick={() => handleAreaClick("CD11350")}>
        <path
          id="CD11350"
          className={`OUTLINE ${selectedArea === "CD11350" ? "selected" : ""}`}
      ...
      <Link to="/11380" onClick={() => handleAreaClick("CD11380")}>
        <path
          id="CD11380"
          className={`OUTLINE ${selectedArea === "CD11380" ? "selected" : ""}`}
      ...
      <Link to="/11410" onClick={() => handleAreaClick("CD11410")}>
        <path
          id="CD11410"
          className={`OUTLINE ${selectedArea === "CD11410" ? "selected" : ""}`}
      ...
      <Link to="/11440" onClick={() => handleAreaClick("CD11440")}>
        <path
          id="CD11440"
          className={`OUTLINE ${selectedArea === "CD11440" ? "selected" : ""}`}
      ...
      <Link to="/11470" onClick={() => handleAreaClick("CD11470")}>
        <path
          id="CD11470"
          className={`OUTLINE ${selectedArea === "CD11470" ? "selected" : ""}`}
      ...
      <Link to="/11500" onClick={() => handleAreaClick("CD11500")}>
        <path
          id="CD11500"
          className={`OUTLINE ${selectedArea === "CD11500" ? "selected" : ""}`}
      ...
      <Link to="/11530" onClick={() => handleAreaClick("CD11530")}>
        <path
          id="CD11530"
          className={`OUTLINE ${selectedArea === "CD11530" ? "selected" : ""}`}
      ...
      <Link to="/11545" onClick={() => handleAreaClick("CD11545")}>
        <path
          id="CD11545"
          className={`OUTLINE ${selectedArea === "CD11545" ? "selected" : ""}`}
      ...
      <Link to="/11560" onClick={() => handleAreaClick("CD11560")}>
        <path
          id="CD11560"
          className={`OUTLINE ${selectedArea === "CD11560" ? "selected" : ""}`}
      ...
      <Link to="/11590" onClick={() => handleAreaClick("CD11590")}>
        <path
          id="CD11590"
          className={`OUTLINE ${selectedArea === "CD11590" ? "selected" : ""}`}
      ...
      <Link to="/11620" onClick={() => handleAreaClick("CD11620")}>
        <path
          id="CD11620"
          className={`OUTLINE ${selectedArea === "CD11620" ? "selected" : ""}`}
      ...
      <Link to="/11650" onClick={() => handleAreaClick("CD11650")}>
        <path
          id="CD11650"
          className={`OUTLINE ${selectedArea === "CD11650" ? "selected" : ""}`}
      ...
      <Link to="/11680" onClick={() => handleAreaClick("CD11680")}>
        <path
          id="CD11680"
          className={`OUTLINE ${selectedArea === "CD11680" ? "selected" : ""}`}
      ...
      <Link to="/11710" onClick={() => handleAreaClick("CD11710")}>
        <path
          id="CD11710"
          className={`OUTLINE ${selectedArea === "CD11710" ? "selected" : ""}`}
      ...
      <Link to="/11740" onClick={() => handleAreaClick("CD11740")}>
        <path
          id="CD11740"
          className={`OUTLINE ${selectedArea === "CD11740" ? "selected" : ""}`}
